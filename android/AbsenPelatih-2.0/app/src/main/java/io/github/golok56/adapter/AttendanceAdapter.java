        ...
        if (currentStudent != null) {
            ...
            rbAttend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view1) {
                    StudentInteractor.sSelectedStudents.add(currentStudent);
                }
            });
            ...
            rbNotAttend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    StudentInteractor.sSelectedStudents.remove(currentStudent);
                }
            });

            // Check the radio button based on the attended student list
            if(StudentInteractor.sSelectedStudents.contains(currentStudent)){
